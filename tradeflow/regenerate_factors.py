...
def regenerate_factors():
    ...
    detailed_df = pd.read_csv('factors_detailed.csv')
    ...
    factors_new.to_csv('factors.csv', index=False)
    ...
    import os
    if os.path.exists('factors_detailed.csv'):
        os.remove('factors_detailed.csv')
